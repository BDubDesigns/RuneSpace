...
const dialogue = {
  [DIALOGUE_IDS.wadeOffer]: {
    ...
    beats: [
      ...
      wadeLocal(EXPRESSION_IDS.concerned, "Your ship's ugly, but it isn't finished. Not yet."),
      wadeLocal(
        EXPRESSION_IDS.neutral,
        "Hull's one problem. Cargo section's another. You're going to need local material, tools, and more work than you can afford.",
      ),
      wadeLocal(EXPRESSION_IDS.scowl, "Yes. I noticed the problem with that sentence too."),
      wadeLocal(
        EXPRESSION_IDS.neutral,
  ...
  [DIALOGUE_IDS.wadeFollowUp]: {
    ...
    npcId: NPC_IDS.wadeRusk,
    beats: [
      wadeLocal(EXPRESSION_IDS.neutral, "Tansy give you the Cutter?"),
      wadeLocal(EXPRESSION_IDS.neutral, "Good."),
      wadeLocal(EXPRESSION_IDS.scowl, "I already have one wreck with your name on it."),
    ],
  },
  [DIALOGUE_IDS.tansyBeforeMission]: {
    ...
    beats: [
      ...
      wadeComms(EXPRESSION_IDS.scowl, "What now."),
      tansyLocal(
        EXPRESSION_IDS.neutral,
      ...
      tansyLocal(EXPRESSION_IDS.smile, "You were supposed to talk to them."),
      ...
      wadeComms(EXPRESSION_IDS.neutral, "Exactly."),
      wadeComms(
        EXPRESSION_IDS.neutral,
        "Fine. Name's Wade Rusk. Recovery, salvage, field repairs. If something around here quits moving, I either make it move again or sell the parts that still do.",
      ),
      tansyLocal(EXPRESSION_IDS.smile, "He's friendlier after lunch."),
      wadeComms(EXPRESSION_IDS.concerned, "Your ship's ugly, but it isn't finished. Not yet."),
      tansyLocal(EXPRESSION_IDS.neutral, "I can get you started."),
      wadeComms(
        EXPRESSION_IDS.scowl,
        "Good. Since you're already standing in front of her, let's all pretend this was the plan.",
      ),
    ],
    action: "accept_mission",
  },
  ...
  [DIALOGUE_IDS.tansyCompletion]: {
    ...
    npcId: NPC_IDS.tansyRusk,
    beats: [
      tansyLocal(EXPRESSION_IDS.neutral, "You must be Wade's crash survivor."),
      tansyLocal(EXPRESSION_IDS.concerned, "He said your ship's still salvageable."),
      tansyLocal(
        EXPRESSION_IDS.neutral,
        "That's not nothing. Most things that hit the ground that hard don't get a second project plan.",
      ),
      tansyLocal(EXPRESSION_IDS.neutral, "If you're fixing it, you're going to need ferrite."),
      tansyLocal(EXPRESSION_IDS.smile, "And if you're getting ferrite, you're going to need this."),
      tansyLocal(EXPRESSION_IDS.neutral, "I threw it together from parts I had lying around."),
      tansyLocal(
        EXPRESSION_IDS.smile,
        "Nothing matches, half of it probably violates a regulation Wade already hates, and it cuts shale just fine.",
      ),
      tansyLocal(
        EXPRESSION_IDS.neutral,
        "Keep it out of the moving bits and try not to point the hot end at anything you're emotionally attached to.",
      ),
  ...
  [DIALOGUE_IDS.tansyAfterClaim]: {
    ...
    beats: [
      ...
      tansyLocal(
        EXPRESSION_IDS.smile,
        "For now, learn how to use the Cutter without removing anything important.",
      ),
    ],
  },
  ...
  [DIALOGUE_IDS.tansyAfterCompletion]: {
    ...
    npcId: NPC_IDS.tansyRusk,
    beats: [
      tansyLocal(EXPRESSION_IDS.smile, "Still have all your fingers?"),
      tansyLocal(EXPRESSION_IDS.neutral, "Good enough."),
      tansyLocal(EXPRESSION_IDS.smile, "Come back when you've made something interesting happen."),
    ],
  },
