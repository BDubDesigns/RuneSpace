...
/**
 * Neutral placeholder portrait (issue #64). Portrait asset generation and
 * player portrait selection are explicitly deferred to a later issue; this
 * narrow presentation boundary keeps a stable aspect ratio and intrinsic
 * dimensions so a later issue can supply a selected asset here without
 * redesigning the profile panel. Decorative: the adjacent identity text
 * carries the accessible name.
 */
function CharacterPortrait({ displayName }: { displayName: string }) {
  return (
    <div
      aria-hidden="true"
      className="grid h-20 w-20 shrink-0 place-items-center border border-[color:var(--rs-border-structural)] bg-[color:var(--rs-surface-raised)] font-display text-3xl font-bold text-[color:var(--rs-text-secondary)]"
          ...
          {profile ? (
            <>
              <div className="mt-3 flex gap-3">
                <CharacterPortrait displayName={profile.displayName} />
