    ...
    patchNotes: [
      {
        ...
        items: [
          ...
          "Practice Welding at the workbench: 2 Scrap Metal per weld, ten sections, up to 2 Slag out, and half the usual Welding XP. One Start keeps welding until the scrap runs out, including while you are offline.",
