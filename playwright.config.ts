...
const canonicalSpecPattern =
  /.*\/(?:account-news|admin-operator|cargo-hold|character-portraits|character-profile|cut-your-teeth|holo-hollow|inventory-equip|location-population|mining|overlay|refining|rusk-recovery|signout|travel|walk-it-off)\.spec\.ts$/;
