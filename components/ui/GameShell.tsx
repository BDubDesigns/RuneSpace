...
export function GameShell({
  ...
  return (
    <div
      className={`mx-auto min-h-screen max-w-7xl px-3 py-3 ${bottomNav ? "pb-[var(--rs-bottom-nav-clearance)]" : "pb-6"} sm:px-6 lg:grid lg:grid-cols-[minmax(0,1fr)_20rem] lg:gap-5`}
    >
