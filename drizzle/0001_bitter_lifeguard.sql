...
CREATE UNIQUE INDEX "equipped_items_character_slot_unique" ON "equipped_items" USING btree ("character_id","suit_slot_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "item_instances_character_id_id_unique" ON "item_instances" USING btree ("character_id","id");--> statement-breakpoint
