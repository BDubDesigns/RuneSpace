 ...
 * singular/plural form — "View 1 other character here",
 * "View 2 other characters here", or "Hide characters here". The regex
 * intentionally accepts both forms so
 * locators work regardless of how many other characters are present.
 */
export const POPULATION_DISCLOSURE_NAME = /^(Show|View|Hide) .*characters? here$/;
